...
plt.plot([j for j in range(len(loss_track))], np.log(diff_e_track), label='diff_e')
plt.plot([j for j in range(len(loss_track))], np.log(terminal_e_track), label='terminal_e')
plt.legend()
plt.savefig("q3-loss(log).png")
...
ax1.plot([j for j in range(len(loss_track))], loss_track, label='loss')
ax1.plot([j for j in range(len(loss_track))], diff_e_track, label='diff_e')
ax1.plot([j for j in range(len(loss_track))], terminal_e_track, label='terminal_e')
plt.legend()
plt.xlabel('number of epoch')
plt.ylabel('trainloss')
ax1.set_xscale('log')
ax1.set_yscale('log')
plt.savefig("q3-loss(log-log).png")
